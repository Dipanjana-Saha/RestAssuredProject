...
import Dipanjana.pageobjects.OrderPage;
...
/*		HashMap<String,String> map = new HashMap<String,String>();
		map.put("email", "dipanjanasaha1998@gmail.com");
		map.put("password", "Dipa#1998");
		map.put("product", "ZARA COAT 3");
		HashMap<String,String> map1 = new HashMap<String,String>();
		map1.put("email", "shetty@gmail.com");
		map1.put("password", "Iamking@000");
		map1.put("product", "ADIDAS ORIGINAL");*/
		List<HashMap<String,String>> data = jsonDataToMap(System.getProperty("user.dir")+"//src//test//java//Dipanjana//data//PurchaseOrder.json");
...
/*	@DataProvider
	public Object[][] getData() throws IOException
	{
		...
		List<HashMap<String,String>> data = getJsonDataToMap(System.getProperty("user.dir")+"//src//test//java//Dipanjana//data//PurchaseOrder.json");
		return new Object[][]  {{data.get(0)}, {data.get(1) } };
